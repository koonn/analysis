...
#python "$SCRIPT_DIR/../src/train.py" --fold 1 --model_name ocsvm_rbf
#python "$SCRIPT_DIR/../src/train.py" --fold 1 --model_name lof
#python "$SCRIPT_DIR/../src/train.py" --fold 1 --model_name isolation_forest
python "$SCRIPT_DIR/../src/train.py" --fold 1 --model_name mixed_nb
